...
export class RenderMap {
	// render map
  	...
  	public static addPlayerToRenderMap(player: Player, renderMap: boolean[][]) : boolean[][] {
  	...
  	public static createRenderMapFromBoards(oldBoard: Board, newBoard: Board) : boolean[][] {
	...
	public static combineRenderMaps(renderMap: boolean[][], newRenderMap: boolean[][]) {
