...
define("Canvas", ["require", "exports", "Utils"], function (require, exports, Utils_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Canvas = (function () {
        ...
        Canvas.prototype.getMaxBoardSize = function (boardSize) {
            ...
            var wrapMargin = Utils_3.Utils.getControlStyle("wrapper", "margin");
            var controlSpacing = Utils_3.Utils.getControlStyle("controlHeader", "marginTop");
            var editSpacing = Utils_3.Utils.getControlStyle("editHeader", "marginTop");
            var offsetHeight = Utils_3.Utils.getControlProperty("controlHeader", "offsetHeight");
            height =
...
define("Collisions", ["require", "exports", "immutable", "Utils", "ramda"], function (require, exports, immutable_6, Utils_4, _) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Collisions = (function () {
        ...
        Collisions.prototype.removeCollidedPlayers = function (collided, players) {
            var collidedIDs = Utils_4.Utils.flattenArray(collided);
            var uniqueIDs = Utils_4.Utils.removeDuplicates(collidedIDs);
        ...
        Collisions.prototype.combinePlayers = function (player1, player2) {
            ...
            var newPlayerType = Utils_4.Utils.getPlayerByValue(this.playerTypes, newValue);
            if (!newPlayerType) {
        ...
        RenderMap.addPlayerToRenderMap = function (player, renderMap) {
            ...
            for (var x = startX; x <= endX; x++) {
                for (var y = startY; y <= endY; y++) {
                    ...
                    var fixedCoords = Utils_5.Utils.correctForOverflow(newCoords, boardSize);
...
define("Editor", ["require", "exports", "BoardSize", "Canvas", "Coords", "Levels", "Loader", "Map", "Renderer", "RenderMap", "TileChooser", "TileSet", "Utils"], function (require, exports, BoardSize_7, Canvas_2, Coords_8, Levels_2, Loader_2, Map, Renderer_2, RenderMap_3, TileChooser_1, TileSet_4, Utils_7) {
    ...
    var Editor = (function () {
        ...
        Editor.prototype.chooseLevelID = function (levelList) {
            ...
            var chosenKey = Utils_7.Utils.getRandomArrayKey(availableLevels);
            if (!chosenKey) {
                return false;
            }
            var levelID = availableLevels[chosenKey].levelID;
